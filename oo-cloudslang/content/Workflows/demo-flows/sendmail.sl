...
operation:
  ...
  inputs:
    ...
    - port : 465
    - from : khalil.m.abdo@gmail.com
    - to : ezmethod@gmail.com
    - cc: khalil.abdo@outlook.com
        required: false
    - bcc:
        required: false
    - subject : test from cloudslang
    - body : mail test
    - html_email:
        required: false
    - htmlEmail:
    ...
    - attachments:
        required: false
    - username: khalil.m.abdo@gmail.com
        required: false
    - password: Sandman1026
        required: false
        sensitive: true
    - character_set:
        required: false
